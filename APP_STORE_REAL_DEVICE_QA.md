...
| RD-14 | Public pages | Run `scripts/verify_app_store_readiness.sh --with-public-pages`, then open the in-app Settings links for Support, Privacy Policy, and Accessibility. | All pages load publicly and match the submitted app behavior. | Not run |
