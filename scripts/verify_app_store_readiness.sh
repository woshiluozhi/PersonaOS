...
require_file "APP_STORE_ACCESSIBILITY.md"
require_file "APP_STORE_AGE_RATING.md"
require_file "APP_STORE_PUBLIC_PAGES.md"
require_file "APP_STORE_REAL_DEVICE_QA.md"
...
require_grep 'POST https://api\.openai\.com/v1/responses' "REAL_AI_INTERACTION.md" "Real AI doc records Responses API endpoint"
require_grep 'does not replay the full chat history' "REAL_AI_INTERACTION.md" "Real AI doc records no full chat history replay"
require_grep 'Fallback replies are visibly marked with `本地模式`' "REAL_AI_INTERACTION.md" "Real AI doc records visible local fallback"
require_grep 'Suggested memories and tasks are never written automatically' "REAL_AI_INTERACTION.md" "Real AI doc records user-confirmed writes"
require_grep 'VoiceOver \| Needs real-device audit before claiming support' "APP_STORE_ACCESSIBILITY.md" "Accessibility draft avoids unverified VoiceOver claim"
require_grep 'Larger Text \| Needs real-device audit before claiming support' "APP_STORE_ACCESSIBILITY.md" "Accessibility draft avoids unverified Larger Text claim"
require_grep 'Dark Interface \| Candidate support' "APP_STORE_ACCESSIBILITY.md" "Accessibility draft records Dark Interface candidate"
require_grep 'Captions \| Not applicable' "APP_STORE_ACCESSIBILITY.md" "Accessibility draft marks captions not applicable"
require_grep 'developer\.apple\.com/help/app-store-connect/manage-app-accessibility/overview-of-accessibility-nutrition-labels' "APP_STORE_ACCESSIBILITY.md" "Accessibility draft links Apple label overview"
...
require_grep 'Offline chat fallback' "APP_STORE_REAL_DEVICE_QA.md" "Real-device QA covers offline fallback"
require_grep 'Local JSON export' "APP_STORE_REAL_DEVICE_QA.md" "Real-device QA covers local JSON export"
require_grep 'Destructive data actions' "APP_STORE_REAL_DEVICE_QA.md" "Real-device QA covers destructive data actions"
require_grep 'Screenshot validation' "APP_STORE_REAL_DEVICE_QA.md" "Real-device QA covers screenshot validation"
...
require_grep 'PersonaOS Accessibility' "docs/accessibility.html" "Accessibility HTML page has accessibility title"
require_grep 'Accessibility Nutrition Label' "docs/accessibility.html" "Accessibility HTML page mentions accessibility labels"
